...
public class ErrorMsg {
    ...
    public static final  String USER_IS_REGISTER="该手机号已经注册";
    ...
    public static final  String UPGRADE_IS_SUBMITTED="审核已提交或已是专业用户(HR)";
    public static final  String SUBMIT_FAIL="提交失败";
    public static final  String NO_FIND="没找到页面或信息不存在";
}
